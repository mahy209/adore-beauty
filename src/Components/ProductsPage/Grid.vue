        ...
        <div class="view-button">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="MenuLink">
              <a class="dropdown-item" @click="sortI('makeUp')">makeUp</a>
              <a class="dropdown-item" @click="sortI('serum')">serum</a>
              <a class="dropdown-item" @click="sortI('masks')">masks</a>
          ...
          <div class="card-selector">
            <div class="card-body p-5">
              <div class="search-title">
                <h4>Catagories  +</h4>
                <br>
                <h6 @click="sortI('makeUp')">makeUp</h6>
                <h6 @click="sortI('serum')">serum</h6>
                <h6 @click="sortI('masks')">masks</h6>
                <h6 @click="sortI('package')">package</h6>
                <br><br><br>
