      ...
      <div class="row justify-content-between">
        ...
        <div class="col-3 col-xl-2 col-lg-3 col-md-3 col-sm-3">
          <div class="footer-widget">
            ...
            <ul class="list-unstyled">
              <router-link to="/products"><li>makeUp</li></router-link>
              <router-link to="/products"><li>serum</li></router-link>
              <router-link to="/products"><li>masks</li></router-link>
              <router-link to="/products"><li>package</li></router-link>
            </ul>
          </div>
        </div>
        ...
        <div class="col-12 col-xl-6 col-lg-3 col-md-3 col-sm-12 text-left text-md-right pb-5">
          <div class="footer-widget">
            <h4>Alexandria</h4>
            <h4>Egypt</h4>
            <a href="mailto:#">salmaebrahim051@gmail.com</a>
            <h6>+20 01068710283</h6>
          </div>
        </div>
